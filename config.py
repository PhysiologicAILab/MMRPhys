...
_C.BASE = ['']
_C.TOOLBOX_MODE = ""
_C.PRECISION = "fp32"  # Can be "fp16" or "fp32"
# -----------------------------------------------------------------------------
# Train settings
# -----------------------------------------------------------------------------\
_C.TRAIN = CN()
...
_C.TRAIN.DATA.PREPROCESS.BIGSMALL.RESIZE.BIG_W = 72
_C.TRAIN.DATA.PREPROCESS.BIGSMALL.RESIZE.BIG_H = 72
...
_C.TRAIN.DATA.PREPROCESS.IBVP.SQ = True
_C.TRAIN.DATA.PREPROCESS.BP4D = CN()
_C.TRAIN.DATA.PREPROCESS.BP4D.DATA_MODE = 'RGB'
_C.TRAIN.DATA.PREPROCESS.SCAMPS = CN()
_C.TRAIN.DATA.PREPROCESS.SCAMPS.LABELS = 'BVP_RSP'
...
_C.VALID.DATA.PREPROCESS.BIGSMALL.RESIZE.BIG_W = 72
_C.VALID.DATA.PREPROCESS.BIGSMALL.RESIZE.BIG_H = 72
...
_C.VALID.DATA.PREPROCESS.IBVP.SQ = True
_C.VALID.DATA.PREPROCESS.BP4D = CN()
_C.VALID.DATA.PREPROCESS.BP4D.DATA_MODE = 'RGB'
_C.VALID.DATA.PREPROCESS.SCAMPS = CN()
_C.VALID.DATA.PREPROCESS.SCAMPS.LABELS = 'BVP_RSP'
...
_C.TEST.DATA.PREPROCESS.BIGSMALL.RESIZE.BIG_W = 72
_C.TEST.DATA.PREPROCESS.BIGSMALL.RESIZE.BIG_H = 72
...
_C.TEST.DATA.PREPROCESS.IBVP.SQ = True
_C.TEST.DATA.PREPROCESS.BP4D = CN()
_C.TEST.DATA.PREPROCESS.BP4D.DATA_MODE = 'RGB'
_C.TEST.DATA.PREPROCESS.SCAMPS = CN()
_C.TEST.DATA.PREPROCESS.SCAMPS.LABELS = 'BVP_RSP'
...
_C.MODEL.MMRPhys.BP_USE_RSP = True
...
_C.MODEL.EFFICIENTPHYS.FRAME_DEPTH = 20
