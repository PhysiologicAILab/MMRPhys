...
if __name__ == "__main__":
    ...
    # parser.add_argument('--path1', default="data/BP4D/BP4D_RGBT_180_72x72",
    #                     dest="path1", type=str, help='path for data-1, e.g. with 180x72x72 res')
    # parser.add_argument('--path2', default="data/BP4D/BP4D_RGBT_180_9x9",
    #                     dest="path2", type=str, help='path for data-2, e.g. with 180x9x9 res')
    # parser.add_argument('--dest', default="data/BP4D/BP4D_RGBT_180",
    #                     dest="dest", type=str, help='path store the merged the data')

    parser.add_argument('--path1', default="data/SCAMPS/SCAMPS_Raw_180_72x72",
                        dest="path1", type=str, help='path for data-1, e.g. with 180x72x72 res')
    parser.add_argument('--path2', default="data/SCAMPS/SCAMPS_Raw_180_9x9",
                        dest="path2", type=str, help='path for data-2, e.g. with 180x9x9 res')
    parser.add_argument('--dest', default="data/SCAMPS/SCAMPS_Raw_180",
                        dest="dest", type=str, help='path store the merged the data')
